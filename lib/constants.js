...
export const NOTE_CATEGORIES = [
  { id: 'general', label: 'General', color: '#9a9aa2' },
  { id: 'process', label: 'Process', color: '#f4511e' },
  { id: 'engineering', label: 'Engineering', color: '#5b8def' },
  { id: 'design', label: 'Design', color: '#7c5cff' },
  { id: 'communication', label: 'Communication', color: '#14ae5c' },
  { id: 'onboarding', label: 'Onboarding', color: '#f5a623' },
]

export const noteCategoryMeta = (id) => NOTE_CATEGORIES.find((c) => c.id === id) || NOTE_CATEGORIES[0]
